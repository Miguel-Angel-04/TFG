...
Trabajo de Fin de Grado — Grado en Ingeniería Informática, Universidad de Málaga. Departamento de Matemática Aplicada. Tutor: Ángel Mora Bonilla.
...
Puesta en marcha
Asegúrate de que Ollama está en ejecución.
Abre el proyecto en RStudio y sitúate en app.R.
Pulsa Run App. La aplicación se abrirá en el navegador.
Carga conocimiento (extraer de un documento con IA, subir un CSV de tripletas o usar los datos de ejemplo), pulsa Extraer Reglas y Contexto y empieza a preguntar.
